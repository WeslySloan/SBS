...
//
//
//		gotoxy(3, 10);printf("旨收收收收收收旬 ");
//		gotoxy(3, 11);printf("早 ?    早 ");
//		gotoxy(3, 12);printf("早      早 ");
//		gotoxy(3, 13);printf("早      早 ");
//		gotoxy(3, 14);printf("早   ?  早 ");
//		gotoxy(3, 15);printf("早      早 ");
//		gotoxy(3, 16);printf("早      早 ");
//		gotoxy(3, 17);printf("早     ?早 ");
//		gotoxy(3, 18);printf("曲收收收收收收旭 ");
//
//		gotoxy(13, 10);printf("旨收收收收收收旬 ");
//		gotoxy(13, 11);printf("早 ?    早 ");
//		gotoxy(13, 12);printf("早      早 ");
//		gotoxy(13, 13);printf("早      早 ");
//		gotoxy(13, 14);printf("早   ?  早 ");
//		gotoxy(13, 15);printf("早      早 ");
//		gotoxy(13, 16);printf("早      早 ");
//		gotoxy(13, 17);printf("早     ?早 ");
//		gotoxy(13, 18);printf("曲收收收收收收旭 ");
//
//
//
...
//			//gotoxy(0, 28);
//
//			if (_kbhit()) {         // If press Anything -> return 1, else -> return 0
//				gotoxy(0, 28);key = _getch();
...
//
//				if (time % 100 == 0) {
//					gotoxy(73 - moving_first, 2);printf("旨收收收收收收旬 ");
//					gotoxy(73 - moving_first, 3);printf("早 ?    早 ");
//					gotoxy(73 - moving_first, 4);printf("早      早 ");
//					gotoxy(73 - moving_first, 5);printf("早   ?  早 ");
//					gotoxy(73 - moving_first, 6);printf("早      早 ");
//					gotoxy(73 - moving_first, 7);printf("早     ?早 ");
//					gotoxy(73 - moving_first, 8);printf("曲收收收收收收旭 ");
//
//					moving_first++;
//
...
//					gotoxy(73 - moving_second, 2);printf("旨收收收收收收旬 ");
//					gotoxy(73 - moving_second, 3);printf("早 ?    早 ");
//					gotoxy(73 - moving_second, 4);printf("早      早 ");
//					gotoxy(73 - moving_second, 5);printf("早   ?  早 ");
//					gotoxy(73 - moving_second, 6);printf("早      早 ");
//					gotoxy(73 - moving_second, 7);printf("早     ?早 ");
//					gotoxy(73 - moving_second, 8);printf("曲收收收收收收旭 ");
//
//					moving_second++;
//
...
//		for (int i = 0; i <= 4; i++) {
//			Sleep(200);
//			gotoxy(8 + i * 15, 8); printf("旨收收收收收收旬 ");
//			gotoxy(8 + i * 15, 9); printf("早 ?    早 ");
//			gotoxy(8 + i * 15, 10);printf("早      早 ");
//			gotoxy(8 + i * 15, 11);printf("早   ?  早 ");
//			gotoxy(8 + i * 15, 12);printf("早      早 ");
//			gotoxy(8 + i * 15, 13);printf("早     ?早 ");
//			gotoxy(8 + i * 15, 14);printf("曲收收收收收收旭 ");
//		}
//
